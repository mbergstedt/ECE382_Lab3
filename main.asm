...
while1:
	...
	jz	 	mainBtn						; Yes, branch back and wait
	bit.b	#7, &P2IN
	jz		moveLeft
	bit.b	#6, &P2IN
	jz		moveRight
...
mainBtn:
	...
	mov.w	#X_INIT,	R10							; used to move the cursor around
	mov.w	#Y_INIT,	R11
...
moveLeft:
	bit.b	#7, &P2IN					; bit 2 of P1IN clear?
	jz		moveLeft					; Yes, branch back and wait
...
moveRight:
	bit.b	#6, &P2IN					; bit 1 of P1IN clear?
	jz		moveRight					; Yes, branch back and wait

	jmp		while1

moveUp:
	bit.b	#10, &P2IN					; bit 5 of P1IN clear?
	jz		moveUp						; Yes, branch back and wait

	jmp		while1

moveDown:
	bit.b	#9, &P2IN					; bit 4 of P1IN clear?
	jz		moveDown					; Yes, branch back and wait
...
;				R13		col
;	Outputs:	none
;	Purpose:	Draws an 8x8 box on the LCD display
;-------------------------------------------------------------------------------
drawBox:
	push	R12
	push	R13
